...
image="${TOPOLOGY_IMAGE:-192.168.0.56:5000/mini-science-ai-os:0.3.13-compact-nodes}"
...
kubectl -n tenant-etri set env deployment/science-job-api PLATFORM_VERSION=0.3.13-compact-nodes
